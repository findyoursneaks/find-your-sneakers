  ...
  return <>
    ...
    <main>
      <section className="hero">
        <span className="eyebrow">THE SMARTER WAY TO SHOP SNEAKERS</span>
        <h1>Find Your<br/><span>Sneakers.</span></h1>
        <p>Compare sneakers from leading stores and find the right pair at the right price.</p>
      ...
      <section id="deals" className="dark"><div className="section">
        <div className="title inverse"><div><span>DEMO CATALOGUE</span><h2>Best Prices Right Now</h2></div><Link className="link" href="/search">Explore deals →</Link></div>
...
function Footer(){return <footer><div className="footbrand"><b>Find Your Sneakers</b><p>Find the right sneaker.<br/>At the right price.</p></div><div className="footlinks"><Link href="/about">About</Link><a href="#">How it works</a><a href="#brands">Brands</a><Link href="/legal/affiliate-disclosure">Affiliate Disclosure</Link><Link href="/legal/privacy">Privacy Policy</Link><Link href="/legal/terms">Terms</Link></div><div className="copyright">© 2026 Find Your Sneakers. We may earn a commission when you buy through retailer links.</div></footer>}
