...
function Header(){return <header className="nav new-nav"><Link className="logo war-logo" href="/"><span>SOLE</span><b>WAR</b></Link><nav><Link href="/search">Sneakers</Link><a href="#brands">Brands</a><a href="#trending">Deals</a><a href="#trending">New Releases</a><a href="#how">Guides</a><Link href="/about">About</Link></nav><form className="nav-search" action="/search"><span>⌕</span><input name="q" aria-label="Search sneakers" placeholder="Search sneakers, brands or models..."/></form><Link className="menu" href="/search">☰</Link></header>}
...
function Footer(){return <footer className="new-footer"><div className="footer-grid"><div><b className="war-logo footer-logo"><span>SOLE</span><b>WAR</b></b><p>Find better deals. Wear a better tomorrow.</p></div><div><b>Shop</b><Link href="/search">Sneakers</Link><a href="#brands">Brands</a><a href="#trending">Deals</a></div><div><b>Help</b><a href="#how">How it works</a><Link href="/legal/affiliate-disclosure">Affiliate disclosure</Link><Link href="/legal/terms">Terms</Link></div><div><b>About</b><Link href="/about">About SOLEWAR</Link><Link href="/legal/privacy">Privacy Policy</Link></div></div><div className="copyright">© 2026 SOLEWAR. All rights reserved. Prices and availability may change. We may earn a commission from qualifying purchases.</div></footer>}
